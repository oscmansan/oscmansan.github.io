...
[View PDF ↗](/files/Oscar_Manas_CV.pdf){: .cv-download target="_blank" rel="noopener"} <span class="cv-note">For the full version, see my [LinkedIn](https://www.linkedin.com/in/oscmansan).</span>
{: .web-only}

## Experience

* **Research Scientist**, Meta Superintelligence Labs, Zurich <span class="cv-date">Oct 2025 -- present</span>
  * Working on generative model distillation and real-time interactive world models, delivering 10× speedups for image-editing models deployed across Meta's products.
...
* **M.Sc. Computer Vision**, [Computer Vision Center](https://www.cvc.uab.es/) / [Universitat Autònoma de Barcelona](https://www.uab.cat) <span class="cv-date">2018 -- 2020</span>
  ...
  * Thesis: [Self-Supervised Visual Representation Learning for Remote Sensing](https://imatge.upc.edu/web/publications/self-supervised-visual-representation-learning-remote-sensing).

* **B.Sc. Informatics Engineering (Computer Science)**, [Universitat Politècnica de Catalunya](https://www.upc.edu) <span class="cv-date">2013 -- 2017</span>
  * Rank 1/235. Grade: 9.52/10. Recognition of outstanding academic achievement.
  * Thesis: [Adapting Deep Neural Networks to a Low-Power Environment](https://upcommons.upc.edu/entities/publication/72ba7eff-c407-4b8a-a1ed-e4291fac11d3).
